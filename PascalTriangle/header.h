...
void CreateMatrix(int64_t**&, int32_t, int32_t);
void PascalTriangle(int64_t**&, int32_t);
int64_t Factorial(int32_t);
int64_t C(int32_t, int32_t);
void InputDimension(int32_t&);
void ZeroMatr(int64_t**&, int32_t, int32_t);
template <class Type>
